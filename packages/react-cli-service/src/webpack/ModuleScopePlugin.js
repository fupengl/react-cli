...
/**
 * link https://github1s.com/facebook/create-react-app/blob/HEAD/packages/react-dev-utils/ModuleScopePlugin.js
 */
class ModuleScopePlugin {
  /**
   * @param {string|string[]} appSrc
  ...
  /**
   * @param resolver {import('webpack').Resolve}
   */
  apply(resolver) {
    const { appSrcs } = this
